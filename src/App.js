  ...
  return (
    <div className="App">
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Ramesh</span></h1>
      </section>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> grameshaagrameshaa@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> +91 99089 42420</h3>
